                ...
                flights && flights.data && flights.data.map(flight => {
                    return (
                        <div className='border bg-white border-gray-200 shadow-xl mt-4 p-8 rounded-md'>
                            ...
                            <div className='mt-2 sm:flex sm:flex-col md:flex md:flex-row lg:flex lg:flex-row xl:flex xl:flex-row justify-between items-center'>
                                <div className='flex sm:w-full md:w-1/3 lg:w-1/3 xl:w-1/3 justify-between '>
                                ...
                                <div className='flex sm:w-full md:w-2/3 lg:w-2/3 xl:w-2/3 gap-3 justify-end mt-4'>
